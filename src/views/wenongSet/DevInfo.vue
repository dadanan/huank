  ...
  <div class="set-wrapper">
    ...
    <div class="set-cell">
      ...
      <div class="cell-item">
        ...
        <div class="cell-right none">
          <span>{{deviceInfoItem.hardVersion}}</span>
        </div>
      </div>
      <div class="cell-item">
        <div class="cell-left">
        ...
        <div class="cell-right none">
          <span>{{deviceInfoItem.softVersion}}</span>
        </div>
      </div>
      <div class="cell-item">
        <div class="cell-left">
        ...
        <div class="cell-right none">
          <span>{{deviceInfoItem.deviceSupport}}</span>
        </div>
      </div>
      <div class="cell-item">
        <div class="cell-left">
        ...
        <div class="cell-right none">
          <span>{{deviceInfoItem.softSupport}}</span>
        </div>
      </div>
      <!-- <div class="cell-item">
...
export default {
  ...
  created() {
    ...
    this.ip = Store.fetch('ip')
    this.deviceInfoItem = JSON.parse(Store.fetch('deviceInfoItem'))
    Loading.open('很快加载好了')
    setTimeout(() => {
      Loading.close()
    }, 300)
