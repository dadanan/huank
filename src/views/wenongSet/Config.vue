			...
			<yd-accordion-item title="关联属性设置">
				<div style="padding: .24rem;background: #f2f2f2;">
					...
					<yd-radio-group v-model="radio1" style="text-align: center; margin-top: 15px;" size='16'>
						<yd-radio val="1"><span style="font-size: 12px; ">设置关联</span> </yd-radio>
						<yd-radio val="2"><span style="font-size: 12px;">设置非关联</span></yd-radio>
					</yd-radio-group>
				</div>
			</yd-accordion-item>
		...
		<div class="create-dialog dialog" v-if="delDevFlag">
			<div class="confirm" style="padding: 0;">
				<div class="confim-top" style="text-align: left; color: #fff; padding: 0 10px 10px; ">
					...
					<div>
						<yd-radio-group color="#00ff00">
							<yd-radio style="margin-top:10px;width:100%;"><span style="color: #fff ">卧室温控器</span></yd-radio>
						</yd-radio-group>
					</div>
				</div>
				<div class="confim-bottom">
					<div class="but" @click="delDevFlag = false">取消</div>
					<div class="but create" @click="delDevFlag = false">确定</div>
				</div>
			</div>
		</div>
		...
		<div class="create-dialog dialog" v-if="addDevFlag">
			<div class="confirm" style="padding: 0;">
				<div class="confim-top" style="text-align: left; color: #fff; padding:20px 10px; ">
					<div class="flex flex-align-center"><label>设备名称:</label>
						<input type="text" name="" id="" value="" class="flex-1" style="background: #fff; border-radius: 5px; border: none; line-height: 30px;" />
					</div>
					<div class="flex flex-align-center" style="margin-top: 10px;"><label>设备地址:</label>
						<input type="text" name="" id="" value="" class="flex-1" style="background: #fff; border-radius: 5px; border: none; line-height: 30px;" />
					</div>
				</div>
				<div class="confim-bottom">
					<div class="but" @click="addDevFlag = false">取消</div>
					<div class="but create" @click="addDevFlag = false">确定</div>
				</div>
			</div>
		</div>
	</div>
