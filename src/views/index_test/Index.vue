<template>
  <div class="main-wrapper" :class="{ active: isOpen === true }" v-if="deviceObj.pm" @touchmove.prevent :style="{ 'background-image': 'url(' + img + ')','background-repeat':'no-repeat','background-size':'cover' }">
    ...
    <div class="info">
      <img src="../../assets/map.png" style="width:12px;height:auto" /> {{ address }}&nbsp;&nbsp;天气{{ deviceObj.weather }}&nbsp;&nbsp;{{ deviceObj.outerTem }}&nbsp;&nbsp;湿度{{ deviceObj.outerHum }}&nbsp;&nbsp;PM2.5:{{ deviceObj.outerPm }}{{ deviceObj.pm.unit }} 质量:{{ deviceObj.pm.mass }}
    </div>
    <div class="but-list">
      <div class="but-group">
    ...
    <div class="center">
      ...
      <div class="temper">
        <div class="t1">
          <p>
            <span>{{ deviceObj.tem.data }}</span>&#176;c</p>
          <p>
        ...
        <div class="t2">
          <p>
            <span>{{ deviceObj.hum.data }}</span>%</p>
          <p>
      ...
      <div class="b-data">
        <span>CO2
          <em>{{ deviceObj.co2.data }}</em> PPM</span>
        <span>TVOC
          <em>{{ deviceObj.tvoc.data }}</em> mg/m³</span>
        <span>甲醛
          <em>{{ deviceObj.hcho.data }}</em> mg/m³</span>
      </div>
    </div>
        ...
        .then(res => {
          if (res.code === 200) {
            ...
            sessionStorage.setItem(
              'deviceInfoItem',
              JSON.stringify(res.data.deviceInfoItem)
            )
            ...
            } else if (res.data.windItems.length === 2) {
              // 内外风扇
