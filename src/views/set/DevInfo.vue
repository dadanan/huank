<template>
  <div class="set-wrapper">
    ...
    <div class="set-cell">
      ...
      <div class="cell-item" v-if="1==2">
        <div class="cell-left"><span>当前连接路由器</span></div>
        <div class="cell-right none"><span>TP-LINK-8D</span></div>
      </div>
      <div class="cell-item" >
        <div class="cell-left"><span>MAC地址</span></div>
        <div class="cell-right none"><span>{{deviceInfoItem.mac}}</span></div>
      </div>
      <div class="cell-item" >
        <div class="cell-left"><span>硬件版本</span></div>
        <div class="cell-right none"><span>{{deviceInfoItem.hardVersion}}</span></div>
      </div>
        <div class="cell-item" >
        <div class="cell-left"><span>软件版本</span></div>
        <div class="cell-right none"><span>{{deviceInfoItem.softVersion}}</span></div>
      </div>
       <div class="cell-item" >
        <div class="cell-left"><span>设备支持</span></div>
        <div class="cell-right none"><span>{{deviceInfoItem.deviceSupport}}</span></div>
      </div>
       <div class="cell-item" >
        <div class="cell-left"><span>软件支持</span></div>
        <div class="cell-right none"><span>{{deviceInfoItem.softSupport}}</span></div>
      </div>
     <!-- <div class="cell-item">
